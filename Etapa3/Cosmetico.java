...
public class Cosmetico extends Loja {
    ...
    //Método construtor
    //Todos os atributos
    public Cosmetico(String nome, int quantidadeFuncionarios, int salarioBaseFuncionario, Endereco enderecoLoja, Data dataFundacao,  int taxaComercializacao){
    ...
    public Cosmetico(String nome, int quantidadeFuncionarios, Endereco enderecoLoja, Data dataFundacao, int taxaComercializacao){
        super(nome, quantidadeFuncionarios, enderecoLoja, dataFundacao);
        this.taxaComercializacao = taxaComercializacao;
    }
