// Classe loja
public class Loja{
    private String lacunaL;//Atributo criado para evitar o pulo de linha do sc.nextLine
    private String nome;
    ...
    public Loja(String lacunaL, String nome, int quantidadeFuncionarios, double salarioBaseFuncionarios, Endereco enderecoLoja, Data dataFundacao){ //Todos os atributos
        this.nome = nome;
    ...
    public Loja(String nome, int quantidadeFuncionarios, double salarioBaseFuncionarios, Endereco enderecoLoja, Data dataFundacao){ //Todos os atributos
        this.nome = nome;
        this.quantidadeFuncionarios = quantidadeFuncionarios;
        this.salarioBaseFuncionarios = salarioBaseFuncionarios;
        this.dataFundacao = dataFundacao;
    ...
    public Loja(String lacunaL, String nome, int quantidadeFuncionarios, Endereco enderecoLoja, Data dataFundacao){ //Somente nome e salário base
        this.nome = nome;
        this.quantidadeFuncionarios = quantidadeFuncionarios;
        this.dataFundacao = dataFundacao;
        this.enderecoLoja = enderecoLoja;
    ...
    public Loja(String nome, int quantidadeFuncionarios, Endereco enderecoLoja, Data dataFundacao){ //Somente nome e salário base
        this.nome = nome;
        this.quantidadeFuncionarios = quantidadeFuncionarios;
        this.dataFundacao = dataFundacao;
        this.enderecoLoja = enderecoLoja;
